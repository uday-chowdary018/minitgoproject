...
const Sidebar = () => {
  ...
  return (
    ...
    <aside className="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 d-none d-md-block" id="sidenav-main">
      ...
      <ul className="navbar-nav">
        <li className="nav-item">
          <a className="nav-link  active" href="../pages/dashboard.html">
            ...
            <FaHome classNameName='text-white' style={{fontSize:'12pt'}}/>
            </div>
        ...
        <li className="nav-item">
          ...
          <TbTableShare classNameName='text-indigo' style={{fontSize:'12pt'}}/>
            </div>
    ...
    <div className="sidenav-footer mx-3 ">
      ...
      <div classNameName="full-background" style={{backgroundImage: `url('../../../../public/assets/img/curved-images/white-curved.jpeg')`}}></div>
